module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        config: {
            target: grunt.option('target') || 'html-blue', // pass --target=html-transparent. possible targets: html-transparent, html-white
